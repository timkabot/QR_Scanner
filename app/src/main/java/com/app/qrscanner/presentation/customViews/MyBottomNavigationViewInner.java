...
public class MyBottomNavigationViewInner extends BottomNavigationView {
    // used for animation
    ...
    public MyBottomNavigationViewInner(Context context) {
        this(context, null);
    }

    public MyBottomNavigationViewInner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyBottomNavigationViewInner(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param visibility
     */
    public MyBottomNavigationViewInner setIconVisibility(boolean visibility) {
        /*
...
//                            System.out.println("mIcon.getMeasuredHeight():" + mIcon.getMeasuredHeight());
     ...
     * @param visibility
     */
    public MyBottomNavigationViewInner setTextVisibility(boolean visibility) {
        ...
        for (BottomNavigationItemView button : mButtons) {
            MyGradientTextView mLargeLabel = getField(button.getClass(), button, "largeLabel");
            MyGradientTextView mSmallLabel = getField(button.getClass(), button, "smallLabel");
...
//            System.out.println("mLargeLabel.getMeasuredHeight():" + getFontHeight(mSmallLabelSize));
     ...
     */
    public MyBottomNavigationViewInner enableAnimation(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//                System.out.println("mLargeLabel:" + mLargeLabelSize);
     ...
     */
    @Deprecated
    public MyBottomNavigationViewInner enableShiftingMode(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//        mMenuView.updateMenuView();
     ...
     */
    @Deprecated
    public MyBottomNavigationViewInner enableItemShiftingMode(boolean enable) {
        /*
        1. get field in this class
        private final BottomNavigationMenuView mMenuView;
...
//        mMenuView.updateMenuView();
     ...
     */
    public MyBottomNavigationViewInner setCurrentItem(int index) {
     ...
     * @return
     */
    public MyBottomNavigationViewInner clearIconTintColor() {
     ...
     * @return
     */
    public MyGradientTextView getSmallLabelAt(int position) {
        /*
         * 1 private final BottomNavigationMenuView mMenuView;
         * 2 private BottomNavigationItemView[] mButtons;
         ...
         */
        BottomNavigationItemView mButtons = getBottomNavigationItemView(position);
        MyGradientTextView mSmallLabel = getField(BottomNavigationItemView.class, mButtons, "smallLabel");
        return mSmallLabel;
    }
     ...
     * @return
     */
    public MyGradientTextView getLargeLabelAt(int position) {
        /*
         * 1 private final BottomNavigationMenuView mMenuView;
         * 2 private BottomNavigationItemView[] mButtons;
         ...
         */
        BottomNavigationItemView mButtons = getBottomNavigationItemView(position);
        MyGradientTextView mLargeLabel = getField(BottomNavigationItemView.class, mButtons, "largeLabel");
        return mLargeLabel;
    }
     ...
     * @param sp
     */
    public MyBottomNavigationViewInner setSmallTextSize(float sp) {
     ...
     * @param sp
     */
    public MyBottomNavigationViewInner setLargeTextSize(float sp) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
            MyGradientTextView tvLarge = getLargeLabelAt(i);
            if (null != tvLarge)
     ...
     * @param sp
     */
    public MyBottomNavigationViewInner setTextSize(float sp) {
        setLargeTextSize(sp);
        setSmallTextSize(sp);
        return this;
    }
     ...
     * @param height   in dp
     */
    public MyBottomNavigationViewInner setIconSizeAt(int position, float width, float height) {
     ...
     * @param height in dp
     */
    public MyBottomNavigationViewInner setIconSize(float width, float height) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @param dpSize  in dp
     */
    public MyBottomNavigationViewInner setIconSize(float dpSize) {
     ...
     * @param height in px
     */
    public MyBottomNavigationViewInner setItemHeight(int height) {
        // 1. get mMenuView
        final BottomNavigationMenuView mMenuView = getBottomNavigationMenuView();
     ...
     */
    public MyBottomNavigationViewInner setTypeface(Typeface typeface, int style) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @attr ref android.R.styleable#TextView_typeface
     */
    public MyBottomNavigationViewInner setTypeface(Typeface typeface) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
     ...
     * @param viewPager
     */
    public MyBottomNavigationViewInner setupWithViewPager(final ViewPager viewPager) {
     ...
     */
    public MyBottomNavigationViewInner setupWithViewPager(final ViewPager viewPager, boolean smoothScroll) {
        if (mViewPager != null) {
     ...
     * necessary calls back to the provided {@link MyBottomNavigationViewInner} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<MyBottomNavigationViewInner> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(MyBottomNavigationViewInner bnve) {
        ...
        public void onPageSelected(final int position) {
            final MyBottomNavigationViewInner bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, MyBottomNavigationViewInner bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
...
//            Log.d("onNavigationItemSelecte", "position:"  + position);
    ...
    public MyBottomNavigationViewInner enableShiftingMode(int position, boolean enable) {
        getBottomNavigationItemView(position).setShifting(enable);
        return this;
    }

    public MyBottomNavigationViewInner setItemBackground(int position, int background) {
        getBottomNavigationItemView(position).setItemBackground(background);
        return this;
    }

    public MyBottomNavigationViewInner setIconTintList(int position, ColorStateList tint) {
        //getBottomNavigationItemView(position).setIconTintList(tint);
        return this;
    }

    public MyBottomNavigationViewInner setTextTintList(int position, ColorStateList tint) {
     ...
     */
    public MyBottomNavigationViewInner setIconsMarginTop(int marginTop) {
     ...
     * @param marginTop in px
     */
    public MyBottomNavigationViewInner setIconMarginTop(int position, int marginTop) {
        /*
